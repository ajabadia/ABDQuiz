...
- Name: a11y-audit.spec.ts >> 🎯 Auditoría de Accesibilidad — ABDQuiz >> [A11Y] Admin asignaciones (AssignmentsList) (/es/admin/assignments)
- Location: tests\a11y-audit.spec.ts:25:9

# Error details

```
Error: Admin asignaciones (AssignmentsList): 5 violación(es)
