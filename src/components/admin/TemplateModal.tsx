        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="text-xs font-mono text-muted-foreground space-y-3">
              ...
              <li><span className="text-foreground font-bold">explicacion</span>: {t('typeString')} (opcional)</li>
              ...
              <li><span className="text-foreground font-bold">tags</span>: {t('typeArrayString')} (opcional)</li>
            </ul>
