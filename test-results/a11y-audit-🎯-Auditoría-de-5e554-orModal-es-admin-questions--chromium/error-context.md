...
- Name: a11y-audit.spec.ts >> 🎯 Auditoría de Accesibilidad — ABDQuiz >> [A11Y] Admin preguntas (QuestionEditorModal) (/es/admin/questions)
- Location: tests\a11y-audit.spec.ts:25:9

# Error details

```
Error: Admin preguntas (QuestionEditorModal): 5 violación(es)
