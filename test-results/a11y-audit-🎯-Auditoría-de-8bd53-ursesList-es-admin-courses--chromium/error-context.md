...
- Name: a11y-audit.spec.ts >> 🎯 Auditoría de Accesibilidad — ABDQuiz >> [A11Y] Admin cursos (CoursesList) (/es/admin/courses)
- Location: tests\a11y-audit.spec.ts:25:9

# Error details

```
Error: Admin cursos (CoursesList): 5 violación(es)
