...
- Name: a11y-audit.spec.ts >> 🎯 Auditoría de Accesibilidad — ABDQuiz >> [A11Y] Admin corpus (FloatingSelector) (/es/admin/corpus)
- Location: tests\a11y-audit.spec.ts:25:9

# Error details

```
Error: Admin corpus (FloatingSelector): 5 violación(es)
